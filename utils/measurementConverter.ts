 ...
 */
export const parseMeasurement = (measureString: string): {
  quantity: number;
  unit: string;
 ...
 */
export const convertToGrams = (quantity: number, unit: string): number | null => {
 ...
 */
export const convertToMilliliters = (quantity: number, unit: string): number | null => {
  const normalizedUnit = unit.toLowerCase().trim();
 ...
 */
export const convertMeasurement = (measureString: string): {
  original: string;
  grams: string | null;
